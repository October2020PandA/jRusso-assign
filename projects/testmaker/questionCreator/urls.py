...
urlpatterns = [
    ...
    path('question_group/testers/', views.qg_tester_ajax, name='qg_tester_ajax'),
    path('question_group/testers/add/', views.qg_testerAdd_ajax, name='qg_testerAdd_ajax'),
    path('question_group/view/', views.qg_viewer, name='qg_viewer'),
    ...
    path('question_group/question/', views.q_forms, name='q_forms'),
    path('question_group/question/add/', views.q_add, name='q_add'),
